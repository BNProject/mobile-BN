            ...
            <View style={{padding: 15}}>
                ...
                <View id="fotoTokoRekap1" style={{marginBottom: 15}}>
                  ...
                  {this.state.data.img_store ? (
                    this.state.errorImgStore ? (
                      <Image
                        source={require('../asset/image-not-found.png')}
                        style={{
                          width: '100%',
                          height: 250,
                          resizeMode: 'cover',
                      ...
                      <Image
                        source={{
                          uri: `${BaseURL}/${this.state.data.img_store}`,
                        }}
                        style={{
                          width: '100%',
                          height: 250,
              ...
              <>
                <View id="fotoFixInRekap" style={{marginBottom: 15}}>
                  ...
                  {this.state.data.img_fixture_in ? (
                    this.state.errorImgFixIn ? (
                      ...
                      <Image
                        source={{
                          uri: `${BaseURL}/${this.state.data.img_fixture_in}`,
                        }}
                        style={{
                          width: '100%',
                          height: 250,
                ...
                <View id="fotoFixTraitRekap" style={{marginBottom: 15}}>
                  ...
                  {this.state.imgFixture1 ? (
                    <Image
                      source={{
                        uri: `${BaseURL}/${
                          this.state.data.tbl_store.fixtureType1.fixture_traits
                        }`,
                      }}
                      style={{
                        width: '100%',
                ...
                <View id="fotoPOGRekap1" style={{marginBottom: 15}}>
                  ...
                  {this.state.imgPOG1 ? (
                    <Image
                      source={{
                        uri: `${BaseURL}/${
                          this.state.data.tbl_store.fixtureType1.POG
                        }`,
                      }}
                      style={{
                        width: '100%',
                ...
                <View id="entryPop1Rekap" style={{marginBottom: 15}}>
                  <Label>
                    Apakah (Grafik fixture teratas) cocok dengan gambar ini ?
                  </Label>
                  <Input
                ...
                {this.state.data.tbl_store.retailer_id === 1 && (
                  <>
                    ...
                    <View id="entryPop2Rekap" style={{marginBottom: 15}}>
                      ...
                      <Input
                        value={
                          this.state.data.entry_pop_pic_2 ? 'Iya' : 'Tidak'
                        }
                        style={{backgroundColor: '#F0F0F0'}}
                        disabled
                      />
                ...
                <View id="fotoFixOutRekap" style={{marginBottom: 15}}>
                  ...
                  {this.state.data.img_fixture_out ? (
                    this.state.errorImgFixOut ? (
                      ...
                      <Image
                        source={{
                          uri: `${BaseURL}/${this.state.data.img_fixture_out}`,
                        }}
                        style={{
                          width: '100%',
                          height: 250,
